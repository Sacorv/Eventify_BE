...
public class OfertaService : IOfertaService
{
    ...
    private List<Oferta> ObtenerLasOfertasDeLosProductosAComprarEnElComercio(Filtro filtro, int idComercio)
    {
        List<Oferta> ofertas = _ofertaRepository.OfertasPorComercioFiltradasPorFecha(idComercio, fechaArgentina);
